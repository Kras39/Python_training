...
class TestAddGroups(unittest.TestCase):
    ...
    def address2(self, wd, address2):
        ...
        wd.find_element_by_name("address2").send_keys(address2.address2)
        # create_phone2
        wd.find_element_by_name("phone2").click()
        wd.find_element_by_name("phone2").clear()
        wd.find_element_by_name("phone2").send_keys(address2.phone2)
        # create_notes
    ...
    def create_birthday(self, wd, birthday):
        ...
        Select(wd.find_element_by_name("bday")).select_by_visible_text(birthday.day)
        wd.find_element_by_xpath("//option[@value='10']").click()
        wd.find_element_by_name("bmonth").click()
        Select(wd.find_element_by_name("bmonth")).select_by_visible_text(birthday.month)
    ...
    def test_add_contact(self):
        ...
        self.create_birthday(wd, Birthday(day="10", month="January", year="2000"))
