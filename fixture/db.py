...
class DbFixture:
    ...
    def get_contact_list(self):
        ...
        try:
            ...
            "fax, email, email2, email3 from addressbook where deprecated='0000-00-00 00:00:00'")
            for row in cursor:
                (id, firstname, middlename, lastname, nickname, company, address, home, mobile, work, fax, email,
                 email2, email3) = row
